                ...
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse">
                        <ul class="nav">
                            ...
                            <li><a href="#contact"><i class="icon-envelope icon-aqua"></i> Contact</a></li>
                        </ul>
                    </div><!--/.nav-collapse -->
                </div>
            </div>
                ...
                <div class="span2 sp2 all-left">
                    <div class="sidebar-nav">
                        <ul class="nav nav-list">
                            ...
                            <li><a href="form.html"><i class="icon-tasks icon-aqua"></i> Forms</a></li>
                            <li class="active"><a href="table.html"><i class="icon-list-alt icon-aqua"></i> Table</a></li>
